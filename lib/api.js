...
// Notify chrome (Navbar) that auth state changed (login/register/logout).
// The Navbar lives in the root layout and does not remount on client
// navigation, so without this it keeps showing the logged-out state
// after router.push('/') from /login.
